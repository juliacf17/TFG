                    ...
                    children: [
                      Expanded(
                        ...
                        child: DropdownButtonFormField<String>(
                          value: widget.existingSubcategories
                      ...
                      Expanded(
                        ...
                        child: TextFormField(
                          ...
                          onFieldSubmitted: (value) {
                            if (value.isNotEmpty) {
                              setState(() {
                                // Agregar la nueva subcategoría a la lista existente
                                widget.existingSubcategories.add(value.trim());
                                // Actualizar el controlador con el valor de la nueva subcategoría
                                subcategoryController.text = value.trim();
                              });
                            }
                          },
                        ),
